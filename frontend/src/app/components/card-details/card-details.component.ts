...
// 1. IMPORTS DO CHART.JS (Essenciais para corrigir o erro "category scale")
...
export class CardDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    // 2. A CORREÇÃO MÁGICA:
    // Registra todos os componentes do gráfico (Linhas, Barras, Escalas, Categorias...)
    // Isso resolve o erro "category is not a registered scale"
